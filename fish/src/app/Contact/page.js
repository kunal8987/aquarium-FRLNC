    ...
    <main className="py-14 background">
      <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
        <div className="max-w-lg mx-auto space-y-3 sm:text-center">
          <h3 className="text-white font-semibold">Contact Us For Enquiry</h3>
        ...
        <div className="mt-12 max-w-lg mx-auto">
          ...
          >
            ...
            <div>
              ...
              <textarea
                required
                className="w-full mt-2 h-36 text-gray-100 px-3 py-2 resize-none appearance-none bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg"
              ></textarea>
            </div>
